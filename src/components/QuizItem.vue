<template>
  <div class="dark:text-white">
    <div class="flex flex-col lg:flex-row items-center justify-between">
      <h2 class="font-bold text-1xl text-start w-full lg:w-auto">
        {{
          $i18n.locale === "en-US" ? question.questionEn : question.questionAr
        }}
      </h2>

      <div class="flex gap-1 justify-end mt-2 lg:mt-0 w-full lg:w-auto">
    ...
    <div class="mt-4 space-y-2">
      ...
      >
        ...
        <input
          ...
          :value="option"
          :name="option"
          class="cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
          @change="
            () => {
